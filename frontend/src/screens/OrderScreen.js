...
import {ORDER_PAY_RESET, ORDER_DELIVERED_RESET, ORDER_DETAILS_RESET} from '../constants/orderConstants'
...
const OrderScreen = ({match, history}) => {
  ...
  const { userInfo } = userLogin
    ...
    order.itemsPrice = addDecimals(order.orderItems.reduce(
       ...
       , [dispatch, history, userInfo, order,successPay, successDelivered, orderId])
